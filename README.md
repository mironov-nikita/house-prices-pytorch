# house-prices-pytorch
A neural network for predicting house prices, built on PyTorch.

### code_houses_prices.py - code 
### data_description.txt - info about data.
### sample_submission.csv - example of submission on Kaggle.
